...
@section('content')
    ...
    <div class="flex items-center bg-green-700 p-6 md:p-8 rounded-[18px] text-white shadow-xl shadow-green-700/50 mb-8">
        <div>
            <h1 class="text-2xl font-bold flex items-center gap-3">
                <i class="fas fa-edit me-2"></i> Edit Data Kampus
            </h1>
            <p class="text-sm opacity-85 mt-1">Perbarui informasi dan status kerjasama kampus mitra.</p>
        </div>
    </div>
    ...
    {{-- ===================== FORM EDIT KAMPUS (Layout 2 Kolom) ===================== --}}
    <div class="bg-white p-6 md:p-8 shadow-xl rounded-2xl border border-gray-100">
        <form action="{{ route('bpdpks.kerjasama.update', $kerjasama->id) }}" method="POST">
                ...
                <div class="col-md-6 border-e pe-md-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="nama_kampus" name="nama_kampus"
                            value="{{ old('nama_kampus', $kerjasama->nama_kampus) }}" required>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" class="form-control" id="kode_kampus" name="kode_kampus"
                            value="{{ old('kode_kampus', $kerjasama->kode_kampus) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="nomor_mou" name="nomor_mou"
                            value="{{ old('nomor_mou', $kerjasama->nomor_mou) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" class="form-control" id="tanggal_mou" name="tanggal_mou"
                            value="{{ old('tanggal_mou', $kerjasama->tanggal_mou) }}">
                ...
                <div class="col-md-6 ps-md-4">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea class="form-control" id="alamat" name="alamat"
                            rows="6">{{ old('alamat', $kerjasama->alamat) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-control" id="status_aktif" name="status_aktif" required>
                            ...
                            <option value="1" {{ old('status_aktif', $kerjasama->status_aktif) == '1' ? 'selected' : '' }}>
                                Aktif</option>
                            <option value="0" {{ old('status_aktif', $kerjasama->status_aktif) == '0' ? 'selected' : '' }}>
                                Nonaktif</option>
                        </select>
            ...
            <div class="flex space-x-3 justify-end">
                {{-- TOMBOL PERBARUI DATA WARNA HIJAU --}}
                <button type="submit"
